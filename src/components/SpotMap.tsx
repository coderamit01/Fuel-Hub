                    ...
                    <div className="-mx-5 -mb-3 px-5 py-3 bg-gradient-to-t from-muted/20 to-transparent border-t border-border/50">
                      <div className="flex items-center justify-center gap-2">
                        <button
                          ...
                          className={`flex-1 flex items-center justify-center gap-1.5 rounded-xl px-3 py-2 text-xs font-semibold transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed shadow-sm ${userVotes[spot.id] === "like"
                        ...
                        <button
                          ...
                          className={`flex-1 flex items-center justify-center gap-1.5 rounded-xl px-3 py-2 text-xs font-semibold transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed shadow-sm ${userVotes[spot.id] === "dislike"
